...
class FirehoseToIcebergStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str,
    ...
    firehose_log_group_name = f"/aws/kinesisfirehose/{source_kinesis_stream.stream_name}"
    ...
    _ = aws_kinesisfirehose.CfnDeliveryStream(self, "FirehoseToIceberg",
      delivery_stream_name=source_kinesis_stream.stream_name,
      ...
      tags=[{"key": "Name", "value": source_kinesis_stream.stream_name}]
    )
